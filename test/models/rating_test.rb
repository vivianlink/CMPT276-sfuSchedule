...
class RatingTest < ActiveSupport::TestCase
  ...
  # end   test "test username	with invalid vaule" do
    ...
    test "test prof for legitimate name" do
		...
		r.prof_name = 'asdfghjkl sdfghjk sdfghjk sdfghjk sdfghj sdfghj sdfghj dfghjk dfghjk dfghjk '
	...
	test "test for legitimate user name" do
		...
		r1.user_name = 'asdfghjkl sdfghjk sdfghjk sdfghjk sdfghj sdfghj sdfghj df'
